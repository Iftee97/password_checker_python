...
# pass as many passwords as arguments as you like, it'll tell you how many times the passwords were hacked
print(main("password123", "audiR8", "ferrari_458_italia"))
